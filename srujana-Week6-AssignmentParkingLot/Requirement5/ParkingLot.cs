...
namespace Requirement5
{
    public class ParkingLot
    {
        ...
        public List<Vehicle> SortByWeight()
        {
            List<Vehicle> list = new List<Vehicle>(_vehicleList);
            list.Sort(); // uses IComparable (weight)
            return list;
        }

        public List<Vehicle> SortByParkedTime()
        {
            return _vehicleList
                .OrderBy(v => v.Ticket.ParkedTime)
                .ToList();
        }
